...
public class TestCondottiere {
    ...
    public void test2() {
        ...
        Quartier [] mainRoi = roi.getJoueur().getCite().toArray(new Quartier[0]);
        ...
        Quartier [] mainAssassin = assassin.getJoueur().getCite().toArray(new Quartier[0]);
        ...
        Quartier [] mainCondottiere = condottiere.getJoueur().getCite().toArray(new Quartier[0]);
